...
pub use protocol::{
    ...
    PipelineConfigPatch, PipelineLlmRequest, ProviderPatch, ReadingOrder, Region, UnlimitedOcrMode,
};
pub use scene::{
    ImageData, ImageRole, MaskData, MaskRole, Node, NodeId, NodeKind, NodeKindTag, Page, PageId,
    ProjectMeta, ProjectStyle, Scene, TextData, TextTranslationContext, Transform,
};
