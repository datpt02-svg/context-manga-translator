...
use koharu_core::{NodeId, Op, PageId, ReadingOrder, Region, Scene, UnlimitedOcrMode};
...
pub struct PipelineRunOptions {
    ...
    /// Unlimited-OCR mode. `Off` uses the default OCR engine;
    /// `Full` routes all blocks through the Unlimited-OCR service.
